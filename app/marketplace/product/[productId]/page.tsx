            ...
            <div className="bg-primary rounded-2xl p-6 space-y-6 sticky top-6">
              ...
              <div className="pt-4 border-t border-gray-300">
                <div className="flex items-baseline gap-1 mb-6">
                  ...
                  <span className="text-xl font-bold text-gray-900 align-super">{String(cents).padStart(2, '0')}</span>
                  <span className="text-xl text-gray-900 ml-1">{product.currency || 'euro'}</span>
                </div>
            ...
            {!isOwnProduct && pendingOffer && (
              <div className="mt-6 bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button className="flex flex-col items-end text-sm text-gray-700 hover:text-gray-900">
                ...
                <div className="space-y-2">
                  <button
                    onClick={handleMakeOffer}
                    className="w-full bg-secondary text-gray-900 py-3 rounded-full text-sm font-medium hover:bg-secondary-2 transition-colors cursor-pointer"
                  >
                    Edit Offer
                  </button>
                  {pendingOffer.status === 'PENDING' && (
                    <button
                      ...
                      className="w-full py-2 text-sm text-gray-700 hover:text-gray-900 font-medium"
                    >
                      Cancel offer
                    </button>
                  )}
